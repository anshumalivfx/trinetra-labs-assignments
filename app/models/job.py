...
class Job(Base):
    ...
    agent_outputs = relationship("AgentOutput", back_populates="job", cascade="all, delete-orphan")
    email_records = relationship("EmailRecord", back_populates="job", cascade="all, delete-orphan")
